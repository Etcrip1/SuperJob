...
<html>
    ...
    <body>
        <form action="exec_inserir_curriculos.jsp" method="POST">
            ...
            <input type="text" name="linguagens"><br>
            <label>Diferenciais:</label><br>
            <input type="text" name="diferenciais"><br>
            <label>Git:</label><br>
            <input type="text" name="git"><br>
            <label>Experiencias:</label><br>
            <input type="text" name="experiencias"><br>
